...
import FlexImg from '../img/a829cc1e-700a-48aa-baad-963b2d9f6080 1.png'
...
return (
    <div className="LoginPg">
        <div className="logInImgContainer">
            ...
            <h5 className="WelcomeMsg">Welcome To The Department Of Mechatronics Engineering</h5>
        </div>
        <div className="LogInSpaceDetails">
            <img src={LogoMark} alt="" className="loginLogo"/>
            <h2 className="LogInText" style={{color:'#09645B'}}>Log Into Your Account</h2>
