...
import LogoNav from '../img/Logomark.svg';
import MenuBtn from '../img/Menu Button.png'
import CancelBtn from '../img/Cancel Button.png'
import HomeBgd from '../img/HomeBackground.png'
...
class NavBar extends Component {
    ...
    render () {
     ...
     <nav>
     <a href="index.html"><img src={LogoNav} alt="" className="LogoNavImg"/></a>
     <div>
        <ul id="navbar" className={this.state.clicked ? "#navbar active" : "#navbar"}>
            ...
            <div id="mobile" onClick={this.handleClick}>
                <i id="bar" className={this.state.clicked ? "fas fa-times size='2xl'" : "fas fa-bars"}></i>
     ...
     <div className="DiscTomorText">
        <h2 style={{marginBottom:"10px"}}>Discover Tomorrow's Innovations today</h2>
        <h4 style={{fontWeight:"300"}}>Welcome To Mechatronics Engineering Excellence!</h4>
